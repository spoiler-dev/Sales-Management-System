...
<body>
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							...
							<li class="active"><a href="qingqiufukuan.html">请求付款<i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	 ...
                        	 <div class="col-md-10 form-inline">
                        	 	...
                        	 	<form action="qingqiufukuan1.html">
                        	 	<label>根据请求付款编号搜索：&nbsp;&nbsp;</label>
                                        <input id="plno" name = "pleasepayno" type="text" class="form-control" style="width: 300px;">&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="qingqiufukuan1.html" ><button class="btn btn-success" type = "submit" id="zhizuo" style="width: 100px;" >制作</button></a>
                                    </form>
                                    </div>
                           </div>
	...
	<script src="assets/js/apps.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
<c:if test="${not empty meme}">
<script type="text/javascript">window.alert("${meme}");</script>
</c:if>
	<script>
    ...
    <c:if test="${not empty qingqiufukuanFailureinfo}">
<script type="text/javascript">window.alert('<c:out value="${qingqiufukuanFailureinfo}"/>');</script>
</c:if>
	...
	$(function(){
		...
		$("#zhizuo").click(function(){
			//使用类型选择器（即直接使用标记名）
			if($("#plno").val() == ""){
				window.alert("请求付款编号不允许为空！");
				
				$("#plno").focus();
				return false;
			}
			var reg = /^\d{1,10}$/;
			if(!reg.test($("#plno").val())){
				window.alert("请求付款编号必须为1至10位整数！"); 
				return false;
			}
			return true;
