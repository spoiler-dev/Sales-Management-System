			...
			<ul class="nav">
				...
				<li class="has-sub">
					...
					<ul class="sub-menu">
						...
						<li class="has-sub">
							<a href="javascript:;"><!--<b class="caret pull-right"></b>--> 商品出库 <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
							<ul class="sub-menu">
				...
				<li class="has-sub active">
					...
					<ul class="sub-menu">
						...
						<li class="active"><a href="qingqiufukuan1.html">请求付款<i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					...
					<div class="panel-body">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered">
								<thead>								
									<tr>
                        <th><label>请求付款单编号：</label><span>${yan1.pleasepayno}</span></th>
						<th><label>请求付款日期：</label><span><fmt:formatDate value="${pleasedate}" pattern="yyyy-MM-dd"/></span></th>
						<th><label>顾客编号:</label><span>${yan1.customerno}</span></th>
						<th><label>顾客姓名：</label><span>${yan1.customername}</span></th>						
						</tr>
								...
								<tbody>
							<%-- 	<c:forEach items="${yanshijava }" var="yan" varStatus="ind"> --%>
								<c:forEach items="${yanshijava}" var="jav">
								<tr class="odd gradeX">
									<%-- <td>${ind.count }</td> --%>
									<td>${jav.orderno}</td>
									<td>${jav.orderdate }</td>
									<td colspan="2">${jav.orderheji }</td>
							...
							<a href="qingqiufukuan2.html?hejitax=${jav.orderheji }&pleasedate=${pleasedate}&pleasepayno=${qingqiufukuan.pleasepayno }&orderno=${qingqiufukuan.orderno }"><button class="btn btn-success" style="float: right">打印请求付款单</button></a>
