...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
			...
			<ul class="nav">
				...
				<li class="has-sub active">
					...
					<ul class="sub-menu">
						...
						<li class="active">
							<a href="shangpindingdanyuebao.html">商品订单月报 <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
   ...
   <ul class="sub-menu">
	...
	<div id="content" class="content">
		<div id="content" class="content">
		<form action = "shangpindingdantu.html">
			<div class="row">
				<div class="col-md-8">
					<input name="orderdateMonth" type="text" readonly="readonly" class="form-control" id="datepicker-default" placeholder="选择日期">
				</div>
				<div class="col-md-4">
					<a href="shangpindingdantu.html"><button type="submit" class="btn btn-primary">打印预览</button></a>
				</div>
			</div>
			</form>
		</div>
